...
T_GD=ephem_data.TGD;       %ephem_data(1)
t_oc=ephem_data.TransmissionTime;       %ephem_data(2)
a_f2=ephem_data.SVClockDriftRate;       %ephem_data(3)
a_f1=ephem_data.SVClockDrift;
a_f0=ephem_data.SVClockBias;
C_rc=ephem_data.Crc;
C_rs=ephem_data.Crs;
C_uc=ephem_data.Cuc;
C_us=ephem_data.Cus;
C_ic=ephem_data.Cic;
C_is=ephem_data.Cis;
Delta_n=ephem_data.Delta_n;
M_0=ephem_data.M0;
e=ephem_data.Eccentricity;
% sqrt_A=sqrt(ephem_data.A); % Note this code assumes the data is A!!
sqrt_A = ephem_data.sqrtA;
t_oe=ephem_data.Toe;
Omega_0=ephem_data.OMEGA0;
i_0=ephem_data.i0;
omega=ephem_data.omega;
dot_Omega=ephem_data.OMEGA_DOT;
